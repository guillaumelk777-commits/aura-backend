...
app.get('/', (req,res) => res.json({ app:'AURA STAR', version:'2.2', status:'ok', share_milestones: SHARE_REWARD_MILESTONES }));
...
const PORT=process.env.PORT||3000;app.listen(PORT,()=>console.log(`AURA STAR API v2.2 en puerto ${PORT}`));
